# HelpOps Project Contributing Guidelines


Thank you for taking the time to contribute to HelpOps Project World. Your help is essential for keeping it great.
...
To get started, look at the existing or [**create a new issue**](https://github.com/HelpOps-Hub/project/issues)!
...
***Actually, our website is currently built using only React and Tailwind CSS. In the future, we will incorporate the full MERN stack, including MongoDB, Node.js, and Express.js. So, if possible, you can raise an issue on that if you want to work on it.***

**Follow these steps to setup HelpOps Project on your local machine 👇**
